...
{	
   ...
   //----------------
	 ...
	 for (int i = 0; i < 2; ++i) {
		 ...
		 if (i == 1)
			 vScale = Vec3(350.f, 20.f, 1.f);

		 pHpUi->Transform()->SetLocalPos(Vec3(-(res.fWidth / 2.f) + (vScale.x / 2.f) + 60.f
			 , (res.fHeight / 2.f) - (vScale.y / 2.f) - (10.f * (i + 1) + (10.f * i))
			 , 1.f));

		 pHpUi->Transform()->SetLocalScale(Vec3(350.f, 10.f, 0.f));
