...
[maxvertexcount(6)]
void GS_Rain(point VTX_OUT _in[1], inout TriangleStream<GS_OUT> OutputStream)
{
    GS_OUT output[4] =
    {
...
float4 PS_Rain(GS_OUT _in) : SV_Target
{
...
// ===============
[numthreads(1024, 1, 1)]
void CS_RainUpdate(int3 _iThreadIdx : SV_DispatchThreadID)
{
